...
import { ConciergeBell, ChevronRight } from "lucide-react";
...
export default async function FacilitiesIndexPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8">
      <h1 className="text-2xl font-bold text-navy-950 mb-2">Facilities Management</h1>
      <p className="text-gray-500 mb-8">Select a hotel to manage its facilities.</p>

      <div className="grid gap-4">
        {hotels?.map((hotel) => (
          <Link 
            key={hotel.id} 
            href={`/admin/facilities/${hotel.slug}`}
